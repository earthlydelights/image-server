...
<a id="wikipedia" class="btn btn-outline-secondary btn-sm" href="#" role="button" title="read wikipedia article"  ><i class="fab fa-wikipedia-w"></i></a>
<a id="image"     class="btn btn-outline-secondary btn-sm" href="#" role="button" title="display image"           ><i class="far fa-image"></i> <span id="width"></span>&nbsp;x&nbsp;<span id="height"></span>&nbsp;<span id="bytes"></span></a>
