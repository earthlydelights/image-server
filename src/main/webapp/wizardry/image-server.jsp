...
<div style="position: relative;width: 100%; margin-top: 1em;">
  ...
  <div style="position: absolute; left: 0; top:0;">
    <button id="loadMetadata" type="button" class="btn btn-outline-secondary">
  ...
  <div style="position: absolute;right: 0; top:0;">
    <button id="reload" type="button" class="btn btn-outline-secondary">
      <span>reset from document<img id="ajaxLoading_reload" src="<c:url value='/assets/images/animated_orange_refresh_22.png'/>"></span>
    </button>
    <button id="save" type="button" class="btn btn-outline-secondary">
